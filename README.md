...
| 04 | [`04-leader-election`](04-leader-election) | Failure detection & leader election: heartbeats, timeouts, and quorum-based election so a cluster survives losing its leader — the failover `03` needs, and the building block under Raft. 🚧 |
